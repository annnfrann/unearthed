            ...
            <Card className='card' textClassName='black-text' title={form.employeename}>
              ...
              <Modal header={form.employeename} trigger={< Button flat className = "review" > Review < /Button>}>
                ...
                <h5>
                  ...
                  {form.mitigationname}</h5>
                <h5>
                  <b>Threat Level of Risk:</b>
                </h5>
                ...
                <form action="#" method="update" id={form.employeename + i}>
                  <input name="supervisorscore" className="supervisorscore" type="range" min="0" max="10" defaultValue="5" id ={i}></input>
